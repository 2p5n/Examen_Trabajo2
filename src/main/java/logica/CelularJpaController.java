...
public class CelularJpaController implements Serializable {
    ...
    public void create(Celular celular) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findCelular(celular.getIdCel()) != null) {
                throw new PreexistingEntityException("Celular " + celular + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
