...
public class RecargasJpaController implements Serializable {
    ...
    public RecargasJpaController() {
        this.emf = Persistence.createEntityManagerFactory("Examen_Trabajo2_PU");
    }
    ...
    public void create(Recargas recargas) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findRecargas(recargas.getIdReca()) != null) {
                throw new PreexistingEntityException("Recargas " + recargas + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
